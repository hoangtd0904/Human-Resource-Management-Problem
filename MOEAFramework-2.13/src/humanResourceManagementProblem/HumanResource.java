...
public class HumanResource {
	...
	public static class MyProblem extends AbstractProblem {
		...
		List<Team> teams;
		GaleShapleyAlgorithm algorithm;
		...
		public MyProblem(int numOfTeam, int numOfEmployee, List<Team> teams, List<Employee> employees) {
			...
			this.teams = teams;
			this.algorithm = new GaleShapleyAlgorithm(numOfTeam, numOfEmployee, teams, employees);
		}
	...
	public static void main(String[] args) throws IOException {
		...
		ReadInput input = new ReadInput("MOEAFramework-2.13/src/data/data.xlsx", 15);
