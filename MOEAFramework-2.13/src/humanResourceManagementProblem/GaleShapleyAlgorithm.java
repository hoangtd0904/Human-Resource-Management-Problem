...
//	init variable
	...
	// constructor
	public GaleShapleyAlgorithm(int numberOfTeam, int numberOfEmployee, List<Team> teams, List<Employee> employees) {
		//
...
//		System.out.println("team 0's employee list: " + Arrays.toString(null));
		...
		GaleShapleyAlgorithm algorithm = new GaleShapleyAlgorithm(2, 3, teams, employees);
